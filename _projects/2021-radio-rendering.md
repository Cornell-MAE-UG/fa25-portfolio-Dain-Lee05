...
![Shaded rendering of earlier version]({{ "/assets/images/lid assembly.png" | relative_url }}){: .inline-image-r style="width: 100px"}
![Shaded rendering of earlier version]({{ "/assets/images/sipper sketch.png" | relative_url }}){: .inline-image-r style="width: 100px"}
![Shaded rendering of earlier version]({{ "/assets/images/sipper lift.png" | relative_url }}){: .inline-image-r style="width: 100px"}
